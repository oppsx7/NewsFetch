...
class NewsHelper {
    ...
    func getArticles(returnArticles: @escaping ([Article]) -> Void) {
        Alamofire.request("https://newsapi.org/v2/top-headlines?country=us&apiKey=38341ed0a08c441381078c01176d283e").responseJSON { response in
            ...
            if let json = response.result.value as? [String: Any],
                ...
                for jsonArticle in jsonArticles {
                    ...
                    self.getArticleCategory(classification, article: &article)
    ...
    func getArticleCategory(_ classification: Classification, article: inout Article) {
        ...
        case .technology:
            ...
            article.categoryColor = UIColor(red: 0.949, green: 0.396, blue: 0.220, alpha: 1)
        }
    }
